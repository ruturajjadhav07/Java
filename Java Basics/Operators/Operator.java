...
public class Operator {
    ...
    public static void main(String[] args) {
        ...
        // Just keep remember that the '+' operator is used to connect the Strings or
        // any Data Type
        ...
        num3 += 3;
        System.out.println("After using Assignment Operator num3 += 7 it gives " + num3);
        System.out.println(num3); // it will print 10. It will assign the value of a which is 7 and then adds 3 in
                                  // it.
        ...
        // num3 -=3;
        // System.out.println(num3); //it will print 4. It will assign the value of a
        // which is 7 and then subtracts 3 in it.
        //
        // num3 *=3;
        // System.out.println(num3); //it will print 21. It will assign the value of a
        // which is 7, and then it will multiply by 3.
        //
        // num3 /=3;
        // System.out.println(num3); //it will print 4. It will assign the value of a
        // which is 7, and then it will divide by 3.
